...
|---|---|---|---|
| IMDRF / FDA principles | Human oversight and lifecycle risk management | Human veto, deterministic safety supervisor, and daily self-test | `THE_ASTRO_LICENSE.md` Article IV; `src/astro/safety_supervisor.py` |
| FDA post-market safety thinking | Preserve incident evidence and fault review | Spine Ledger concept and fault replay package | `THE_ASTRO_LICENSE.md` Article IV.4.5; `docs/SAFETY_CASE_SUMMARY.md` |
...
| Jaron Lanier-inspired inspectability | Traceability, semantic grounding, and human-centered accountability | Training influence logs, grounding checks, and independent safety channel | `THE_ASTRO_LICENSE.md` Article V.5.1–5.3 |
...
[5]: https://www.jaronlanier.com/ "Jaron Lanier — Official Website"
